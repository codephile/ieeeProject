...
**/
     ...
     public class ExtractLinks
     {
        ...
        private static final String LINE_SEPARATOR = System.getProperty("line.separator");
		 ...
		 public ExtractLinks(File reutersDir, File outputDir)
		 {
		...
		public void make_index()
		{
			try
			{
				...
				File [] htmlFiles = reutersDir.listFiles(new FileFilter()
				{
					public boolean accept(File file)
					{
        ...
        /**
         ...
         public static void main(String[] args)
         {
             ...
             if (reutersDir.exists())
             {
                 ...
                 outputDir.mkdirs();
                 ExtractLinks extractor = new ExtractLinks(reutersDir, outputDir);
                 //extractor.extract();
         ...
         {
            System.err.println("Usage: java -cp <...> org.apache.lucene.benchmark.utils.ExtractLinks <Path to Reuters SGM files> <Output Path>");
         }
     }